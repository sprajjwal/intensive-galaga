  ...
  create() {
    ...
    this.physics.add.collider(this.playerLasers, this.enemies, function(
      ...
      if (enemy) {
        ...
        enemy.explode(true);
        playerLaser.destroy();
        let cur = playerLaser.player.getData("score");
        playerLaser.player.setData("score", cur + 1);
        scoreDiv.innerHTML = `Score: ${playerLaser.player.getData("score")}`;
      }
    });
